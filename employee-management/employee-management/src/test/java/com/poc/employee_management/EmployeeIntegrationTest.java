...
class EmployeeIntegrationTest {
    ...
    void testUpdateEmployee() throws Exception {
        ...
        EmployeeDTO updatedEmployee = new EmployeeDTO(
                "Menara", "Maybank", "maybank@gmail.com", "IT", 60000.0);
    ...
    void testGetEmployees() throws Exception {
        ...
        mockMvc.perform(get("/api/employees?page=1&size=10"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.content[0].employees[0].firstName").value("Menara"))
                .andExpect(jsonPath("$.content[0].employees[0].lastName").value("Maybank"));
    }
